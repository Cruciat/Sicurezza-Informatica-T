# 🔐 Security Exam Toolkit

Raccolta di materiale per l'esame di **Sicurezza Informatica** — guide, scheletri di consegna, script e slide del corso.
...
> ⚠️ **Consiglio pratico:** Le domande a crocetta sono storicamente quasi identiche di anno in anno. Conoscerle a memoria è la strategia più efficace per massimizzare il punteggio su quella parte dell'esame.
...
> ℹ️ La teoria è inclusa per completezza, ma ai fini dell'esame è **largamente superflua**: le crocette coprono già tutto il necessario da memorizzare.
